...
class discordManager:
    ...
    def updatePresencePlaying(self):
        ...
        self.RPC.update(
            ...
            large_image = "https://github.com/Alxay/The-Binding-of-Isaac-Rebirth-discord-rich-presence/Images/Rooms/Cellar_I_1.png",
            large_text = f"{floor_name} | {self.rooms.get(current_room, 'Unknown Room')} ",
            small_image = f"https://github.com/Alxay/The-Binding-of-Isaac-Rebirth-discord-rich-presence/Images/Characters/playerportrait_{player_name.lower()}.png",
